...
const svg = `<svg width="1024" height="1024">
  <rect x="50" y="30" width="924" height="45" fill="white"/>
  <text x="512" y="62" font-family="Arial, sans-serif" font-weight="900" font-size="34" fill="black" text-anchor="middle">PICKLEBALL SAHASI VE MUTFAK KURALLARI</text>
</svg>`;
